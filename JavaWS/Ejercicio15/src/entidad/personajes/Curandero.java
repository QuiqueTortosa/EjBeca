...
public class Curandero extends Personaje{
	...
	public String toString() {
		return "El curandero "+getNombre()+" tiene un arma "+getArma().getClass().getSimpleName()+" con una inteligencia de "+getAtributo()+" y una vida de "+getVida();
	}
	...
	/*
	 * Devuelve la cantidad de vida que se cura en base a su inteligencia
	 */
	public int cura() {
